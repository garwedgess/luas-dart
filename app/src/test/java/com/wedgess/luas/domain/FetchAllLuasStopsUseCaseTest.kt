...
class FetchAllLuasStopsUseCaseTest {

    @MockK
    private lateinit var luasRepository: LuasRepository
    private lateinit var fetchAllLuasStopsUseCase: FetchAllLuasStopsUseCase

    @Before
    fun setup() {
        MockKAnnotations.init(this)
        fetchAllLuasStopsUseCase = FetchAllLuasStopsUseCase(luasRepository)
    }
    ...
    fun `invoke should return repository result when successful`() = runTest {
        ...
        // When
        val result = fetchAllLuasStopsUseCase().first()
