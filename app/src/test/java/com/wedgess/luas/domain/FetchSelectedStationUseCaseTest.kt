...
class FetchSelectedStationUseCaseTest {
    ...
    fun setup() {
        ...
        fetchSelectedStationUseCase = FetchSelectedStationUseCase(preferencesRepository)
    }
    ...
    fun `invoke should return red line station when RED line is requested`() = runTest {
        ...
        // When
        val result = fetchSelectedStationUseCase(LuasLineEntity.RED).first()
    ...
    fun `invoke should return green line station when GREEN line is requested`() = runTest {
        ...
        // When
        val result = fetchSelectedStationUseCase(LuasLineEntity.GREEN).first()
