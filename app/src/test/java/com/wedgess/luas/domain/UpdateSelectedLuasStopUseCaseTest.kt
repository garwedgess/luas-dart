...
class UpdateSelectedLuasStopUseCaseTest {
    ...
    fun setup() {
        ...
        updateSelectedLuasStopUseCase = UpdateSelectedLuasStopUseCase(preferencesRepository)
    }
    ...
    fun `invoke should update red line station when RED line is provided`() = runTest {
        ...
        // When
        val result = updateSelectedLuasStopUseCase(stationAbbreviation, LuasLineEntity.RED)
    ...
    fun `invoke should update green line station when GREEN line is provided`() = runTest {
        ...
        // When
        val result = updateSelectedLuasStopUseCase(stationAbbreviation, LuasLineEntity.GREEN)
